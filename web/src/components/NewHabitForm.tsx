  ...
  return (
    <form onSubmit={createNewHabit} className="w-full flex flex-col mt-6">
      ...
      <input
        ...
        className="p-4 rounded-lg mt-3 bg-zinc-800 text-white placeholder:text-zinc-4B8r3B4p7yhRXuBWLqsQ546WR43cqQwrbXMDFnBi6vSJBeif8tPW85a7r7DM961Jvk4hdryZoByEp8GC8HzsqJpRN4FxGM9-zinc-900"
        autoFocus
        value={title}
